function [] = effectofnetworkopenaccess(start)
 ...
 % emu = 50;
   ...
   hill = 1.2;
    ...
    ty= start(1);
    ty2=ty + 39;
    justtheparforpartopenaccess(ty,ty2,A,N,costratio,cat,cab,cutofft,cutoffb,nharvest,nbycatch,inE,nseasons,hill,hsb,fa,fm,dataforrandomtarget);
