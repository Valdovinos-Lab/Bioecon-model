...
function [Ap] = discreteeffortsopenaccess(Simhbdata,k,N,costratio,cat,cab,cutofft,cutoffb,nharvest,nbycatch,inE,nseasons,hill, hsb,fa,fm,target,bycatch)
...
% selected randomly
% 3. fishing occurs till it's profitable 
