  ...
  %  Data = cell(1,400); %all data regarding variables for each network
   ...
   cutoffb = cutoffvalues(i4,2);
    ...
    for i=1:length(present)
        ...
        j = sprintf('sharedtargetbycatchquota_k%d_Emax1_cutofft%d_cutoffb%d_cat2.000000e-03_cab2.000000e-03_costratio2.500000e-01_hill1.200000e+00_hsb2.000000e-01_fa4.000000e-01_fm4.000000e-01.mat',present(1,i),cutofft,cutoffb);
        a = load(j);
        a = a.var;
...
%         modeobservables(i,:) = A6;
 ...
 j = sprintf('Newmedian_minby_survSTB_cutofft%d_cutoffb%d.mat',cutofft,cutoffb);
    var = cell(1,2);
